...
class FeatureManager {
  ...
  Feature<BinaryFeatureState> registerBinaryFeature(String name,
      {BinaryFeatureState defaultState,
      String description,
      List<StateResult<BinaryFeatureState> Function()> decisionSources}) {
    var newFeature =
        Feature<BinaryFeatureState>(name: name, defaultState: defaultState, decisionSources: decisionSources);
